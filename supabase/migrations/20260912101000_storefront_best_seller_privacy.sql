drop function if exists public.get_storefront_best_sellers(integer);

create function public.get_storefront_best_sellers(limit_count integer default 25)
returns table (product_external_id text)
language sql
security definer
