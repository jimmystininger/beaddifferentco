...
begin
  ...
  shipping_amount := case
    when shipping_method = 'priority' then greatest(9, case when subtotal >= 35 then 0 else 5 end + 5)
    when subtotal >= 35 then 0
    else 5
  end;
  ...
  insert into public.orders (
    ...
    shipping_name, shipping_address, initcap(shipping_method) || ' shipping'
